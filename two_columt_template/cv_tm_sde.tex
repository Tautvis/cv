...
% compile with lualatex: lualatex cv_tm_sde.tex
%
...
learning & \textsc{Matlab}, \textsc{Weka}, \textsc{Hadoop},\\
& \textsc{Spark}\\
Software & \textsc{Java}, \textsc{Python}, \textsc{Scala}, Linux,\\
development & \textsc{Jenkins}, maven, gradle, sbt,\\
...
\begin{itemize}
	...
	\item Halite I \& II - autonomous agents via ML
